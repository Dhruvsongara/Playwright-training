...
- Name: unicornProductValidate.spec.ts >> Logged-in User flows >> validate airpods search
- Location: tests/unicornProductValidate.spec.ts:68:9
...
Call log:
  - waiting for getByRole('button', { name: ' Search' })
    - locator resolved to <button type="button" data-toggle="modal" _ngcontent-cfp-c53="" data-target="#search_modal" class="btn only-search-btn mr-2">…</button>
